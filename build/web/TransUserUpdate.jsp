<%-- 
    Document   : TransUserUpdate
    Created on : 4 Mar, 2023, 9:19:19 AM
    Author     : ashug
--%>
...
//                con = dbConnector.getConnection();
                ...
                String query = "SELECT * FROM transowner WHERE email='"+email+"'";
...
<html>
<head>
<title>Transport Owner Upadte</title>
...
<body style="background-repeat: no-repeat; background: url(images/Transport1.jpg);background-size: 100% 100%;">
	<!-- main -->
	<div class="main-w3layouts wrapper" style="">
		<h1 style="font-size: 8vh; font-weight: bold;">Rural Helper</h1>
		<div class="main-agileinfo">
            <h1>Transport Owner <br>Update</h1>
			<div class="agileits-top">
				<form action="TrasnOwnerUpdateChecker" method="post">
                                    <%
                                    if(rs.next())
                                    {%>
					...
					<input class="text" type="password" name="password" value="<%=rs.getString("password")%>" placeholder="Enter Password" required="">
                                        ...
                                        <input class="text" type="text" name="vehicletype" value="<%=rs.getString("vehicletype")%>" placeholder="Enter Vehicle Type" required="">
        ...
        {
            response.sendRedirect("TransOwner.html");
        }
%>
