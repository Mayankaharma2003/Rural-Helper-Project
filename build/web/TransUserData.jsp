<%-- 
    Document   : TransUserData
    Created on : 4 Mar, 2023, 9:11:20 AM
    Author     : ashug
--%>
...
//                con = dbConnector.getConnection();
                ...
                String query = "SELECT * FROM transuser;";
...
<html lang="en">
  <head>
    ...
    <title>Transport User Data</title>
  </head>
  <body>
  <header style="padding: 2vh;">
      <form action="TransUserEmailChecker" method="post">
          <input name="email" type="hidden" value="<%=email%>">
      To Update Owner Details<input type="submit" style="border: none; background: transparent;" value="Click here."></a>
