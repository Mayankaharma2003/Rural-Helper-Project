 ...
 * @author ashug
 */
public class TransUserDataToOwnerAuth 
{
    public boolean isRegis(TransUserDataToOwnerDTO teacher)
    {
        ...
        if(scontactno!=null && sname!=null && district!=null && state!=null)
        {
            try{
                ...
                String query = "INSERT INTO `transuser`(`ucontactno`,`uname`,`state`,`district`) VALUES ('"+scontactno+"','"+sname+"','"+state+"','"+district+"');";
